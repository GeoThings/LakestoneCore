...
public protocol PropertyListRepresentable {
    init(fromPersistentPropertyList propertyList: PersistentPropertyList, withKey key: String) throws
    func writePersistently(toPersistentPropertyList propertyList: PersistentPropertyList, withKey key: String)
    //func removePersistently(fromPersistentPropertyList propertyList: PersistentPropertyList, withKey key: String)
}
...
public class PersistentPropertyList {
    ...
    public init(applicationContext: Context, preferenceFileKey: String){
    ...
    public func getStringSet(forKey key: String) -> Set<String>? {
        #if COOPER
