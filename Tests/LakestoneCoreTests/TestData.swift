...
class TestData: Test {
    ...
    public func testNumericConversion(){
        ...
        let littleEndianData = Data.from(long: testNumber, usingLittleEndianEncoding: true)
        let bigEndianData = Data.from(long: testNumber, usingLittleEndianEncoding: false)
    ...
    public func testUTF8StringWrapping(){
        ...
        let testData = Data.from(utf8EncodedString: testString)
